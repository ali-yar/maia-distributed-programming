...
public class TrainLastLayer {
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(TrainLastLayer.class);
    ...
    public static void main(String [] args) throws IOException{
        ...
        evaluateModel(vgg16Transfer, dataIterValid, saveBestModel, dataNorm);
        ...
        while(epochIdx < epochs) {
            ...
            if ((epochIdx+1) == epochs) {
                ...
                evaluateModel(vgg16Transfer, dataIterTest, true, dataNorm);
            }
            ...
            if ((epochIdx+1) == 1 || (epochIdx+1) == 7 || (epochIdx+1)%9 == 0) {
                ...
                evaluateModel(vgg16Transfer, dataIterTest, false, dataNorm);
            }
    ...
    public static ComputationGraph getModel() throws IOException {
        ...
        if (optimizer.equalsIgnoreCase("adam")) {
            updater = new Adam.Builder().learningRate(learnRate).build();
        ...
        FineTuneConfiguration fineTuneConf = new FineTuneConfiguration.Builder().updater(updater).seed(seed).build();
       ...
       return new TransferLearning.GraphBuilder(vgg16)
                ...
                .addLayer("predictions", outputLayer,featureExtractionLayer)
                .build();
    }

    private static double evaluateModel(ComputationGraph vgg16Transfer, DataSetIterator dataIter, boolean saveBestModel,
    ...
    private static void saveModel(ComputationGraph model, String dir, DataNormalization dataNorm) throws IOException{
        String fullPath = dir + TrainLastLayer.class.getSimpleName() + "_model.zip";
